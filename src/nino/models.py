...
class NNA(models.Model):
    ...
    certificado_nacimiento=models.ImageField(upload_to="img",verbose_name="Certificado de nacimiento",default="asd")
    ...
    orden_ingreso=models.FileField(upload_to="img",verbose_name="Orden de ingreso",)
    estado=models.BooleanField(default=True,verbose_name="Estado")
...
class Area_Social(models.Model):
    ...
    descripcion=models.TextField(verbose_name="Descripción de la fuente de estrés")
...
class Area_Psicologica(models.Model):
    ...
    descripcion=models.TextField(verbose_name="Descripcion de la enfermedad psicológica")
